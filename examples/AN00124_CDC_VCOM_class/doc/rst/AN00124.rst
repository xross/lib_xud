...
To setup the demo hardware the following boards are required.
  ...
  - XK-EVK-XU316 board
      ...
      - 2 x USB cables (A to micro-b)

.. figure:: images/xk-evk-xu316.pg
  :scale: 110%
...
The hardware should be configured as displayed above for this demo:
  ...
  - Connect a USB cable from the USB receptical on the XK-EVK-XU316 board to the host PC

  - The XK-EVK-XU316 board requires power via the *5V IN* USB Micro-B receptical
...
This command will cause a binary (.xe file) to be generated the `bin` directory,

Launching the demo application
------------------------------

Once the demo example has been built we can execute the application on the `xcore.ai` device.
...
.. nopoints::
  ...
  * `XMOS` XTC Tools User Guide
    ...
    https://www.xmos.com/documentation/XM-014363-PC-10/html/
